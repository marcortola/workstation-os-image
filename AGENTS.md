...
- `tooling/portable/ai-cli-setup/` is a portable, secret-free projection of the personal
...
- `just ai-bundle`: regenerate the portable `tooling/portable/ai-cli-setup/` bundle from the seeds.
